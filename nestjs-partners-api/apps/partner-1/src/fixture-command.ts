...
import { Partner1Module } from './partner-1.module';
  ...
  const events = [
    {
      ...
      name: 'Event 001 - Partner 1',
      description: 'Event 001 Description - Partner 1',
      price: 100,
      date: '2021-10-10T10:00:00',
    },
    {
      id: 'e0352b32-7698-4805-b029-28302b3a911f',
      name: 'Event 002 - Partner 1',
      description: 'Event 002 Description - Partner 1',
      price: 200,
